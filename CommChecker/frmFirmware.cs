...
namespace PCBsetup.Forms
{
    public partial class frmFirmware : Form
    {
        ...
        private string FirmwareDate = "05-Dec-2023";
        private frmModule mf;
        private bool UseDefault = false;
        private TeensyWatcher watcher;

        public frmFirmware(frmModule CallingForm)
        {
            InitializeComponent();
            mf = CallingForm;
        ...
        {
            UseDefault = true;
            tbHexfile.Text = "Default file version date: " + FirmwareDate;
        }
            ...
            try
            {
                ...
                if (teensy != null)
                {
                    if (UseDefault)
                    {
                        ...
                        File.WriteAllBytes(filename, CommChecker.Properties.Resources.TeensyTestComm_ino);
                    }
                    else
                    {
