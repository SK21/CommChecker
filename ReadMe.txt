...
3. set the network subnet

 It should now be connected. It will show the PGNs going from the app and coming from the teensy. The Product PGN Time should be about 0.200 seconds.
